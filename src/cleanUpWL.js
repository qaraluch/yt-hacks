...
} = require("../puppeteer/removeVideosFromPlaylist");
...
async function run() {
  try {
    ...
    // turned off lazy loading all vids due to puppeteer performance
    // see: tiljs
    ...
    // * copy videos
    console.info("[TASK] Remove videos from Watch Later playlist:");
    await removeVideosFromPlaylist(page);
